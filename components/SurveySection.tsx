...
function LangIcon({ label }: { label: string }) {
  if (label === "Java") return (
    <svg width="28" height="36" viewBox="0 0 48 60" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M18 42s-2.5 1.5 1.8 2c5.2.6 7.8.5 13.5-.6 0 0 1.5 1 3.6 1.8-12.8 5.5-29-.3-18.9-3.2z" fill="#0074BD"/>
      <path d="M16 36.5s-2.8 2.1 3 2.8c4.5.5 10 .6 17.6-.8 0 0 1 1 2.7 1.6-15.6 4.6-33 .4-23.3-3.6z" fill="#0074BD"/>
      <path d="M28.5 24.5c3.2 3.7-0.8 7-0.8 7s8-4.1 4.3-9.3c-3.4-4.8-6-7.2 8.1-15.4 0 0-22.1 5.5-11.6 17.7z" fill="#EA2D2E"/>
      <path d="M40 46.5s1.8 1.5-2 2.7c-7.3 2.2-30.3 2.9-36.7.1-2.3-1 2-2.4 3.4-2.7 1.4-.3 2.2-.2 2.2-.2-2.5-1.8-16.4 3.5-7 5 25.5 4.1 46.5-1.9 40.1-4.9z" fill="#0074BD"/>
      <path d="M19 30s-11.5 2.7-4.1 3.7c3.2.4 9.5.3 15.4-.2 4.8-.4 9.7-1.3 9.7-1.3s-1.7.7-2.9 1.5c-11.8 3.1-34.6 1.7-28-1.5 5.5-2.7 9.9-2.2 9.9-2.2z" fill="#0074BD"/>
      <path d="M35 39.5c12-6.2 6.4-12.2 2.6-11.4-.9.2-1.4.4-1.4.4s.4-.6 1.1-.8c8.1-2.8 14.3 8.4-2.5 12.9 0 0 .2-.2.2-.1z" fill="#EA2D2E"/>
      <path d="M31 0s6.6 6.6-6.2 16.7c-10.3 8.1-2.3 12.7 0 18-6-5.4-10.4-10.1-7.4-14.5C21.5 13.6 33.5 10.7 31 0z" fill="#EA2D2E"/>
      <path d="M20.5 54.5c11.5.7 29.2-.4 29.6-5.5 0 0-.8 2-9.5 3.6-9.8 1.8-21.9 1.6-29.1.4 0 0 1.5 1.2 9 1.5z" fill="#0074BD"/>
    </svg>
  );
  if (label === "Python") return (
    <svg width="32" height="32" viewBox="0 0 256 255" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <linearGradient id="pyBlue" x1="12%" y1="12%" x2="75%" y2="88%">
          <stop offset="0" stopColor="#387EB8"/>
          <stop offset="1" stopColor="#366994"/>
        </linearGradient>
        <linearGradient id="pyYellow" x1="15%" y1="15%" x2="80%" y2="85%">
          <stop offset="0" stopColor="#FFE052"/>
          <stop offset="1" stopColor="#FFC331"/>
        </linearGradient>
      </defs>
      <path d="M126.9 0C62.4 0 66.3 27.3 66.3 27.3l.1 28.3h61.8v8.5H41.6S0 59.4 0 124.6s37.5 62.9 37.5 62.9h22.4v-30.3s-1.2-37.5 36.9-37.5h63.6s35.7.6 35.7-34.5V35.7S201.6 0 126.9 0zm-35.3 20.6c6.4 0 11.5 5.2 11.5 11.5s-5.2 11.5-11.5 11.5-11.5-5.2-11.5-11.5 5.1-11.5 11.5-11.5z" fill="url(#pyBlue)"/>
      <path d="M129.1 255c64.5 0 60.6-27.3 60.6-27.3l-.1-28.3H127.8v-8.5h86.6s41.6 4.7 41.6-60.5-37.5-62.9-37.5-62.9h-22.4v30.3s1.2 37.5-36.9 37.5H95.6s-35.7-.6-35.7 34.5v57.5S54.4 255 129.1 255zm35.3-20.6c-6.4 0-11.5-5.2-11.5-11.5s5.2-11.5 11.5-11.5 11.5 5.2 11.5 11.5-5.1 11.5-11.5 11.5z" fill="url(#pyYellow)"/>
    </svg>
  );
  if (label === "C++") return (
    <svg width="36" height="36" viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg">
      <path d="M64 4L8 36v56l56 32 56-32V36L64 4z" fill="#00599C"/>
      <path d="M64 4L8 36l56 32 56-32L64 4z" fill="#004482"/>
      <path d="M8 36v56l56 32V68L8 36z" fill="#659AD2"/>
      <text x="34" y="76" fontFamily="Arial Black, sans-serif" fontWeight="900" fontSize="38" fill="white" letterSpacing="-2">C++</text>
    </svg>
  );
  return null;
}
  ...
  return (
    ...
    >
      ...
      <div>
        ...
        {desc && <p className="text-xs mt-0.5" style={{ color: "rgba(148,163,184,0.6)" }}>{desc}</p>}
      </div>
    </motion.button>
  );
}
...
function SurveyModal({ onClose }: { onClose: () => void }) {
  ...
  const canNext = () => {
    if (step === 1) return form.name.trim().length >= 2 && isValidEmail(form.email);
    if (step === 2) return !!form.classGroup;
            ...
            >
              ...
              <div className="mb-5">
                <h2 className="text-xl font-extrabold text-white mb-1">
                  {step > 1 && form.name ? `Hi ${form.name.split(" ")[0]}! 👋` : headings[step - 1].q}
                </h2>
                  ...
                  >
                    {step === 1 && (
                      <div className="flex flex-col gap-3">
                        <PremiumInput placeholder="Your full name" value={form.name}
                          onChange={v => setForm({ ...form, name: v })} autoFocus />
                        <div>
                          <PremiumInput type="email" placeholder="you@example.com" value={form.email}
                    ...
                    {step === 2 && (
                      <div className="flex flex-col gap-2.5">
                        {CLASS_OPTIONS.map(opt => (
                          <OptionCard key={opt.value} selected={form.classGroup === opt.value}
                    ...
                    {step === 3 && (
                      <div className="flex flex-col gap-2.5">
                        {EXPERIENCE_OPTIONS.map(opt => (
                          <OptionCard key={opt.label} selected={form.experience === opt.label}
                            onClick={() => setForm({ ...form, experience: opt.label })}
                            emoji={opt.emoji} label={opt.label} desc={opt.desc} />
                        ))}
                      </div>
                    )}
                    {step === 4 && (
                      <div className="grid grid-cols-2 gap-2 mx-auto" style={{ maxWidth: 320 }}>
                        {INTERESTS.map(item => {
                          const sel = form.interest === item.label;
                          return (
                            <motion.button
                              key={item.label}
                              type="button"
                              ...
                              whileTap={{ scale: 0.96 }}
                              onClick={() => setForm({ ...form, interest: item.label })}
                              className="relative flex flex-col items-center justify-center gap-2 rounded-xl transition-all duration-200"
                              style={{
                                padding: "14px 8px",
                                background: sel ? "rgba(124,58,237,0.22)" : "rgba(255,255,255,0.04)",
                                border: sel ? "1.5px solid rgba(124,58,237,0.7)" : "1.5px solid rgba(255,255,255,0.08)",
                                boxShadow: sel ? "0 0 18px rgba(124,58,237,0.25)" : "none",
                              }}
                            >
                              {sel && (
                                <motion.span initial={{ scale: 0 }} animate={{ scale: 1 }}
                              ...
                              {item.type === "emoji" ? (
                                ...
                                <LangIcon label={item.label} />
                              )}

                              <div className="text-center">
                                <p className="font-semibold text-xs leading-tight" style={{ color: sel ? "#e9d5ff" : "#e2e8f0" }}>{item.label}</p>
                                <p className="text-[9px] mt-0.5 leading-tight" style={{ color: "rgba(148,163,184,0.55)" }}>{item.desc}</p>
                              </div>
                            </motion.button>
                          );
                        })}
              ...
              <div className="flex items-center justify-between mt-6 pt-5 border-t border-white/8">
                ...
                <motion.button
                  ...
                  {step < STEPS ? <><span>Continue</span><ArrowRight size={14} /></> : <span>Get My Recommendation ✨</span>}
                </motion.button>
              </div>
            </motion.div>
          )}
          ...
          {analyzing && (
            ...
            >
              <motion.div animate={{ rotate: 360 }}
                transition={{ duration: 1, repeat: Infinity, ease: "linear" }} className="mb-5">
            ...
            >
              <div className="flex items-center gap-2 mb-4">
                ...
                <p className="text-[10px] font-bold uppercase tracking-widest"
                  ...
                  Your Recommendation, {form.name.split(" ")[0]} 🎯
                </p>
              </div>
              ...
              >
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    <h3 className="text-xl font-extrabold text-white">{recommended.name}</h3>
...
export default function SurveySection() {
  ...
  return (
    <section id="survey" className="relative py-20 px-6 overflow-hidden"
      style={{ background: "linear-gradient(135deg,#0a0118 0%,#0d0221 60%,#0f0f1a 100%)" }}>

      <div className="absolute top-[-30%] left-[-10%] w-[500px] h-[500px] rounded-full pointer-events-none"
        style={{ background: "radial-gradient(circle,rgba(124,58,237,0.12) 0%,transparent 70%)", filter: "blur(60px)" }} />
      <div className="absolute bottom-[-30%] right-[-10%] w-[500px] h-[500px] rounded-full pointer-events-none"
      ...
      <div className="max-w-3xl mx-auto text-center relative z-10">
        ...
        >
          <span className="inline-block text-[10px] font-bold uppercase tracking-widest mb-4 px-3 py-1.5 rounded-full"
            style={{ background: "rgba(124,58,237,0.15)", border: "1px solid rgba(124,58,237,0.3)", color: "#a78bfa" }}>
            ✦ Personalized Recommendation
          </span>

          <h2 className="text-3xl md:text-4xl font-extrabold mb-4 leading-tight">
            💻 Build Your Future <span className="gradient-text">With Code</span>
          </h2>
          <p className="text-slate-400 text-sm md:text-base mb-8 max-w-xl mx-auto">
            Get personalized coding recommendations in seconds.
          </p>

          <motion.button
            whileHover={{ scale: 1.06, boxShadow: "0 12px 36px rgba(124,58,237,0.5)" }}
            whileTap={{ scale: 0.96 }}
