...
const founders = [
  {
    ...
    bio: "With years of experience shaping young minds at Allen, Sudhanshu brings a deep understanding of how students learn best. His teaching philosophy — make it simple, make it fun — is the backbone of CodingKida's curriculum design.",
    tag: "Educator & Mentor",
  ...
  },
  {
    ...
    bio: "A seasoned software architect with real-world industry experience at Volvo India, Natwar brings cutting-edge tech knowledge to CodingKida. He ensures every course is aligned with what the industry actually needs.",
